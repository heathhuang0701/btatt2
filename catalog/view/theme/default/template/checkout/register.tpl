  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-account"><?php echo $entry_account; ?></label>
        <input type="text" name="account" value="" placeholder="<?php echo $entry_account; ?>" id="input-payment-account" class="form-control" />
      </div>
            
      <div class="form-group required">
        <label class="control-label" for="input-payment-name"><?php echo $entry_name; ?></label>
