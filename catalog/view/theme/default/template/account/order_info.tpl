      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            {
            ?>
              <td class="text-left" colspan="2"><?php echo $product['name']; ?>
            ...
            ?>
              ...
              <?php 
              if($product['reorder'] && $product['is_main'] == 1)
              { 
              ?>
              ...
              if($product['return'] && $product['is_main'] == 1) 
              { 
              ?>
            ...
            <tr>
              <td class="text-left" colspan="2"><?php echo $voucher['description']; ?></td>
