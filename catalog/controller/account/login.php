...
class ControllerAccountLogin extends Controller {
	...
	protected function validate() {
		...
		$login_info = $this->model_account_customer->getLoginAttempts($this->request->post['account']);
		...
		if (!$this->error) {
			if (!$this->customer->login($this->request->post['account'], $this->request->post['password'])) {
				$this->error['warning'] = $this->language->get('error_login');

				$this->model_account_customer->addLoginAttempt($this->request->post['account']);
			} else {
				$this->model_account_customer->deleteLoginAttempts($this->request->post['account']);
