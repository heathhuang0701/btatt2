...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		if (isset($this->session->data['guest']['name'])) {
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['name'] = $this->request->post['name'];
			...
			$this->session->data['payment_address']['name'] = $this->request->post['name'];
			...
			if ($this->session->data['guest']['shipping_address']) {
				$this->session->data['shipping_address']['name'] = $this->request->post['name'];
