        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-online-service"><?php echo $entry_online_service; ?></label>
                <div class="col-sm-10">
                  <select id="input-online-service" name="config_online_service" class="form-control">
                  	<option value="0" <?php if($config_online_service == '0')echo 'selected="selected"'; ?>><?php echo $button_close; ?></option>
                    <option value="1" <?php if($config_online_service == 1)echo 'selected="selected"'; ?>><?php echo $button_open; ?></option>
                  </select>
                </div>
              </div>
              <?php if ($locations) { ?>
            ...
            <div class="tab-pane" id="tab-store">
			  ...
			  <!-- template -->
              <input type="hidden" name="config_template" id="input-template" value="<?php echo $config_template; ?>" />
			  <!-- template -->
			...
			<div class="tab-pane" id="tab-about">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-team-description"><?php echo $entry_team_description; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_team_description" placeholder="<?php echo $entry_team_description; ?>" id="input-team-description"><?php echo $config_team_description; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-prod-description"><?php echo $entry_prod_description; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_product_description" placeholder="<?php echo $entry_prod_description; ?>" id="input-prod-description"><?php echo $config_product_description; ?></textarea>
                </div>
              </div>
            </div>
            <!-- -->
...
$('#input-team-description').summernote({height: 300});
$('#input-prod-description').summernote({height: 300});
