            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left"><?php echo $column_show; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($news['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $news['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $news['id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $news['title']; ?></td>
                  <td class="text-right"><?php echo $news['time']; ?></td>
				  <td class="text-right"><?php echo $news['show']; ?></td>
