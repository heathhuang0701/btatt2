          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($teacher['id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $teacher['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $teacher['id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $teacher['name']; ?></td>
                  <td class="text-right"><?php echo $teacher['sort']; ?></td>
