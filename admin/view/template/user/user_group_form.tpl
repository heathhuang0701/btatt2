      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($permissions['access'] as $pky => $permission) 
                { 
                ?>
                <div class="checkbox">
                  <label>
                    ...
                    <?php echo $permissions_text['access'][$pky]; ?>
                    <?php 
                    } 
                    else 
                    {
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($permissions['modify'] as $pky => $permission) { ?>
                <div class="checkbox">
                  <label>
                    <?php 
                    ...
                    <?php echo $permissions_text['modify'][$pky]; ?>
                    <?php 
                    } 
                    else 
                    { 
