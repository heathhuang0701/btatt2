                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="account" value="<?php echo $account; ?>" placeholder="<?php echo $entry_account; ?>" id="input-account" class="form-control" />
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-name<?php echo $address_row; ?>"><?php echo $entry_name; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][name]" value="<?php echo $address['name']; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $address_row; ?>" class="form-control" />
...
function addAddress() {
	...
	html += '    <label class="col-sm-2 control-label" for="input-name' + address_row + '"><?php echo $entry_name; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][name]" value="" placeholder="<?php echo $entry_name; ?>" id="input-name' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
