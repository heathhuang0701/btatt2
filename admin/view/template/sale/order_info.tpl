          ...
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><a href="<?php echo $customer; ?>" target="_blank"><?php echo $name; ?></a></td>
              </tr>
              <tr>
                <td><?php echo $text_account; ?></td>
                <td><a href="<?php echo $account; ?>" target="_blank"><?php echo $account; ?></a></td>
              </tr>
              <?php } else { ?>
              <tr>
                <td><?php echo $text_customer; ?></td>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {
                  ?>
                  <td class="text-left"><?php echo $text_add_price; ?></td>
...
$('#button-history').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		url: 'index.php?route=api/order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
