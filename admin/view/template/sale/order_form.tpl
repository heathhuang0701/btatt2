          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="account" value="<?php echo $account; ?>" id="input-account" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-cart">
              <div class="table-responsive">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <td class="text-left" colspan="2"><?php echo $column_product; ?></td>
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      <?php if($order_product['is_main'] == 1)
                      {
                      ?>
					  <td class="text-left" colspan="2"><?php echo $order_product['name']; ?><br />
                      ...
                      ?>
                      <td class="text-left">
                      	<?php echo $text_add_price; ?>
                      	<input type="hidden" name="product[<?php echo ($product_row-1); ?>][add_item][<?php echo $order_product['product_id']; ?>]" value="<?php echo $order_product['quantity']; ?>" />
                    ...
                    <?php 
                    if($order_product['is_main'] == 1) $product_row++; 
                    ?>
                    <?php } ?>
                    <?php $voucher_row = 0; ?>
                    <?php foreach ($order_vouchers as $order_voucher) { ?>
                    <tr>
                      <td class="text-left" colspan="2"><?php echo $order_voucher['description']; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payment_address" id="input-payment-address" class="form-control">
                    ...
                    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['name'] . ', ' . $address['address'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-name"><?php echo $entry_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="name" value="<?php echo $payment_name; ?>" id="input-payment-name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-shipping">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-name"><?php echo $entry_name; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="name" value="<?php echo $shipping_name; ?>" id="input-shipping-name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=api/cart/products&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
		success: function(json) {
			...
			if (json['products']) {
				for (i = 0; i < json['products'].length; i++) {
					...
					html += '<tr>';
					html += '  <td class="text-left" colspan="2">' + product['name'] + ' ' + (!product['stock'] ? '<span class="text-danger">***</span>' : '') + '<br />';
					html += '  <input type="hidden" name="product[' + prod_cnt + '][product_id]" value="' + product['product_id'] + '" />';
					...
					if (product['option']) {
						for (j = 0; j < product['option'].length; j++) {
							...
							if (option['type'] == 'select' || option['type'] == 'radio' || option['type'] == 'image') {
								html += '<input type="hidden" name="product[' + prod_cnt + '][option][' + option['product_option_id'] + ']" value="' + option['product_option_value_id'] + '" />';
							}
							...
							if (option['type'] == 'text' || option['type'] == 'textarea' || option['type'] == 'file' || option['type'] == 'date' || option['type'] == 'datetime' || option['type'] == 'time') {
								html += '<input type="hidden" name="product[' + prod_cnt + '][option][' + option['product_option_id'] + ']" value="' + option['value'] + '" />';
							}
						}
					}
					...
					html += '  <td class="text-right">' + product['quantity'] + '<input type="hidden" name="product[' + prod_cnt + '][quantity]" value="' + product['quantity'] + '" /></td>';
					...
					{
						for(k = 0; k < product['add_products'].length; k++)
						{
							prod_cnt = prod_cnt + 1;
							add = product['add_products'][k];
							
							html += '<tr>';
							html += '  <td class="text-left"><?php echo $text_add_price; ?></td>';
							html += '  <td class="text-left">' + add['name'] + ' ' + (!add['stock'] ? '<span class="text-danger">***</span>' : '');
							html += '  <input type="hidden" name="product[' + prod_cnt + '][product_id]" value="' + add['product_id'] + '" />';
							
							html += '</td>';	
							html += '  <td class="text-left">' + add['model'] + '</td>';
							html += '  <td class="text-right">' + add['quantity'] + '<input type="hidden" name="product[' + prod_cnt + '][quantity]" value="' + add['quantity'] + '" /></td>';
							html += '  <td class="text-right">' + add['price'] + '</td>';
							html += '  <td class="text-right">' + add['total'] + '</td>';
							html += '  <td class="text-center" style="width: 3px;"><button type="button" value="' + add['key'] + '___' + add['product_id'] + '" data-toggle="tooltip" title="<?php echo $button_remove; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
							html += '</tr>';	
						}
					}
					// ===
			...
			if (json['vouchers']) {
				for (i in json['vouchers']) {
					...
					html += '<tr>';
					html += '  <td class="text-left" colspan="2">' + voucher['description'];
				...
				for (i = 0; i < json['products'].length; i++) {
					...
					if(product['add_products'])
					{
						for(k = 0; k < product['add_products'].length; k++)
						{
							...
							html += '<tr>';
							html += '  <td class="text-left"><?php echo $text_add_price; ?></td>';
							html += '  <td class="text-left">' + add['name'] + ' ' + (!add['stock'] ? '<span class="text-danger">***</span>' : '') + '</td>';
							html += '  <td class="text-left">' + add['model'] + '</td>';
							html += '  <td class="text-right">' + add['quantity'] + '</td>';
							html += '  <td class="text-right">' + add['price'] + '</td>';
							html += '  <td class="text-right">' + add['total'] + '</td>';
							html += '</tr>';
						}
			...
			if (json['vouchers']) {
				for (i in json['vouchers']) {
					...
					html += '<tr>';
					html += '  <td class="text-left" colspan="2">' + voucher['description'] + '</td>';
					html += '  <td class="text-left"></td>';
					html += '  <td class="text-right">1</td>';
					html += '  <td class="text-right">' + voucher['amount'] + '</td>';
					html += '  <td class="text-right">' + voucher['amount'] + '</td>';
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#tab-customer input[name=\'name\']').val(item['name']);
		...
		for (i in  item['address']) {
			html += '<option value="' + item['address'][i]['address_id'] + '">' + item['address'][i]['name'] + ', ' + item['address'][i]['address'] + ', ' + item['address'][i]['city'] + ', ' + item['address'][i]['country'] + '</option>';
		}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$.ajax({
					url: 'index.php?route=api/cart/add&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
				...
				$.ajax({
					url: 'index.php?route=api/voucher/add&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=api/cart/remove&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-payment input[name=\'name\']').val(json['name']);
...
$('select[name=\'shipping_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-shipping input[name=\'name\']').val(json['name']);
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=api/shipping/method&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: 'index.php?route=api/coupon&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: 'index.php?route=api/voucher&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: 'index.php?route=api/reward&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (order_id == 0) {
		var url = 'index.php?route=api/order/add&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = 'index.php?route=api/order/edit&token=<?php echo $token; ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + order_id;
	}
