...
class ModelUserUser extends Model {
	...
	public function getUsers($data = array()) {
		$sql = "SELECT ".DB_PREFIX."user.*,".DB_PREFIX."user_group.name AS group_name FROM ".DB_PREFIX."user
				LEFT JOIN ".DB_PREFIX."user_group ON ".DB_PREFIX."user.user_group_id = ".DB_PREFIX."user_group.user_group_id";

		if ($data['admin'] != '1')
		{
			$sql .= ' WHERE '.DB_PREFIX.'user.user_group_id <> 0 ';	
		}
