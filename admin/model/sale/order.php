...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *, (SELECT c.name FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer FROM `" . DB_PREFIX . "order` o WHERE o.order_id = '" . (int)$order_id . "'");
	...
	public function getOrders($data = array()) {
		...
		if (!empty($data['filter_customer'])) {
			$sql .= " AND o.name LIKE '%" . $this->db->escape($data['filter_customer']) . "%'";
		}
