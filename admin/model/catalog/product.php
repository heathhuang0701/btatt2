...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if(isset($data['add_price'])) 
		{
			foreach($data['add_price'] as $add_price) 
			{
				$this->db->query("INSERT INTO " . DB_PREFIX . "add_price SET product_id = '" . (int)$product_id . "',add_product_id = '" . (int)$add_price['product_id'] . "',add_price = '" . (int)$add_price['add_price'] . "' ");
			}
		}
