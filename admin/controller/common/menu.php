...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['class'] = $this->url->link('information/class', 'token=' . $this->session->data['token'], 'SSL');
		$data['board'] = $this->url->link('information/board', 'token=' . $this->session->data['token'], 'SSL');
		$data['teacher'] = $this->url->link('information/teacher', 'token=' . $this->session->data['token'], 'SSL');
