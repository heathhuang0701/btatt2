...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_team_description'] = $this->language->get('entry_team_description');
		$data['entry_prod_description'] = $this->language->get('entry_prod_description');
		$data['entry_online_service'] = $this->language->get('entry_online_service');
		...
		if (isset($this->request->post['config_online_service'])) {
			$data['config_online_service'] = $this->request->post['config_online_service'];
		} else {
			$data['config_online_service'] = $this->config->get('config_online_service');
		}
		...
		if (isset($this->request->post['config_team_description'])) {
			$data['config_team_description'] = $this->request->post['config_team_description'];
		} else {
			$data['config_team_description'] = $this->config->get('config_team_description');
		}
		
		if (isset($this->request->post['config_product_description'])) {
			$data['config_product_description'] = $this->request->post['config_product_description'];
		} else {
			$data['config_product_description'] = $this->config->get('config_product_description');
		}
