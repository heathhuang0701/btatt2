...
class ControllerApiCustomer extends Controller {
	public function index() {
		...
		if ($this->request->post['customer_id']) {
			...
			$customer_info = $this->model_api_customer->getCustomer($this->request->post['customer_id']);
		...
		$custom_fields = $this->model_api_custom_field->getCustomFields($customer_group_id);
