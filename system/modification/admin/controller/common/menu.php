...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$permission = $this->model_user_user_group->getPermission($this->session->data['user_id']);
		
		$arr['home'] = 'common/dashboard';
		$arr['affiliate'] = 'marketing/affiliate';
		$arr['api'] = 'user/api';
		$arr['attribute'] = 'catalog/attribute';
		$arr['attribute_group'] = 'catalog/attribute_group';
		$arr['backup'] = 'tool/backup';
		$arr['banner'] = 'design/banner';
		$arr['category'] = 'catalog/category';
		$arr['country'] = 'localisation/country';
		$arr['contact'] = 'marketing/contact';
		$arr['coupon'] = 'marketing/coupon';
		$arr['currency'] = 'localisation/currency';
		$arr['customer'] = 'sale/customer';
		$arr['customer_fields'] = 'sale/customer_field';
		$arr['customer_group'] = 'sale/customer_group';
		$arr['customer_ban_ip'] = 'sale/customer_ban_ip';
		$arr['custom_field'] = 'sale/custom_field';
		$arr['download'] = 'catalog/download';
		$arr['error_log'] = 'tool/error_log';
		$arr['feed'] = 'extension/feed';
		$arr['filter'] = 'catalog/filter';
		$arr['fraud'] = 'extension/fraud';
		$arr['geo_zone'] = 'localisation/geo_zone';
		$arr['information'] = 'catalog/information';
		$arr['installer'] = 'extension/installer';
		$arr['language'] = 'localisation/language';
		$arr['layout'] = 'design/layout';
		$arr['location'] = 'localisation/location';
		$arr['modification'] = 'extension/modification';
		$arr['manufacturer'] = 'catalog/manufacturer';
		$arr['marketing'] = 'marketing/marketing';
		$arr['module'] = 'extension/module';
		$arr['option'] = 'catalog/option';
		$arr['order'] = 'sale/order';
		$arr['order_status'] = 'localisation/order_status';
		$arr['payment'] = 'extension/payment';
		$arr['paypal_search'] = 'payment/pp_express/search';
		$arr['product'] = 'catalog/product';
		$arr['report_sale_order'] = 'report/sale_order';
		$arr['report_sale_tax'] = 'report/sale_tax';
		$arr['report_sale_shipping'] = 'report/sale_shipping';
		$arr['report_sale_return'] = 'report/sale_return';
		$arr['report_sale_coupon'] = 'report/sale_coupon';
		$arr['report_product_viewed'] = 'report/product_viewed';
		$arr['report_product_purchased'] = 'report/product_purchased';
		$arr['report_customer_activity'] = 'report/customer_activity';
		$arr['report_customer_online'] = 'report/customer_online';
		$arr['report_customer_order'] = 'report/customer_order';
		$arr['report_customer_reward'] = 'report/customer_reward';
		$arr['report_customer_credit'] = 'report/customer_credit';
		$arr['report_marketing'] = 'report/marketing';
		$arr['report_affiliate'] = 'report/affiliate';
		$arr['report_affiliate_activity'] = 'report/affiliate_activity';
		$arr['review'] = 'catalog/review';
		$arr['return'] = 'sale/return';
		$arr['return_action'] = 'localisation/return_action';
		$arr['return_reason'] = 'localisation/return_reason';
		$arr['return_status'] = 'localisation/return_status';
		$arr['shipping'] = 'extension/shipping';
		$arr['setting'] = 'setting/store';
		$arr['stock_status'] = 'localisation/stock_status';
		$arr['tax_class'] = 'localisation/tax_class';
		$arr['tax_rate'] = 'localisation/tax_rate';
		$arr['total'] = 'extension/total';
		$arr['upload'] = 'tool/upload';
		$arr['user'] = 'user/user';
		$arr['user_group'] = 'user/user_permission';
		$arr['voucher'] = 'sale/voucher';
		$arr['voucher_theme'] = 'sale/voucher_theme';
		$arr['weight_class'] = 'localisation/weight_class';
		$arr['length_class'] = 'localisation/length_class';
		$arr['zone'] = 'localisation/zone';
		$arr['recurring'] = 'catalog/recurring';
		$arr['order_recurring'] = 'sale/recurring';
		$arr['class'] = 'information/class';
		$arr['board'] = 'information/board';
		$arr['teacher'] = 'information/teacher';
		$arr['news'] = 'information/news';
		
		if(count($permission['access']) > 0)
		{
			foreach($permission['access'] as $per)
			{
				$aa = array_search($per,$arr);
				if($aa != false)
				{
					$data[$aa] = $this->url->link($arr[$aa], 'token=' . $this->session->data['token'], 'SSL');
				}
			}
		}
		...
		$data['text_teacher'] = $this->language->get('text_teacher');
